...
<p style="text-align: justify; text-indent: 40px; line-height: 1.6;">
  This is to certify that <strong>[Client Name]</strong>, Filipino/s, of legal age/s from <strong>[Client Address]</strong> is eligible to avail outright financial assistance for <strong>[Relationship]</strong> burial expenses.
</p>
