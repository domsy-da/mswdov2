...
$query = "SELECT 
    beneficiary_id,
    client_name,
    SUBSTRING_INDEX(client_address, ',', 1) as sitio,
    TRIM(SUBSTRING_INDEX(SUBSTRING_INDEX(client_address, ',', 2), ',', -1)) as barangay,
    SUM(amount) as total_amount
    FROM transactions
    GROUP BY beneficiary_id, client_name, client_address 
    ...
    <div class="container">
        ...
        <table id="expensesTable">
            ...
            <tbody>
                ...
                ?>
                <tr class="expense-row" data-barangay="<?php echo htmlspecialchars($row['barangay']); ?>">
